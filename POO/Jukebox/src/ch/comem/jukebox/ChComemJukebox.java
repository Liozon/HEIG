...
public class ChComemJukebox {
    ...
    // Affichage des choix possible par l'utilisateur
    ...
    public static void actionsUtilisateur() {
        switch (choix) {
            ...
            case 3:
                finProgramme();
                break;
            // Default: si une autre touche a été pressée
            default:
    ...
    public static void insertionCD() {
        ...
        if (cdLecture <= 5) {
            ...
            System.out.println("Erreur. Merci d'entrer un nombre entre 1 et 5: ");
            System.out.println("");
            insertionCD();
        }
    }

    // Affichage du CD actuellement dans le jukebox
    ...
    // Liste toutes les informations des CD créés
