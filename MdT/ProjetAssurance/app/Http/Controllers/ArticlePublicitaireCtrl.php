...
class ArticlePublicitaireCtrl extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            // Tentative d'enregistrement de l'article publicitaire
            ArticlePublicitaire::createNew($validate->getData());
            // Message de succès, puis redirection vers la liste des article
